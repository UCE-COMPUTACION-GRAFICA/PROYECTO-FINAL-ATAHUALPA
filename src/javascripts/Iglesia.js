...
var triangulo, mallaextrusion;

export default class Iglesia {
  constructor(pos_x, pos_y, pos_z, rot_x, rot_y, rot_z, esc_x, esc_y, esc_z, scene) {
    this.pos_x = pos_x;
    this.pos_y = pos_y;
    this.pos_z = pos_z;
  ...
  crearIglesia() {
    ...
    pivotPoint.add(cubo);
    //parte de columnas
    textura=t.crear_texturas("texturas/muro2.jpg", 1, 2);
    //izquierda
    ...
    pivotPoint.add(cubo);
    //parte amarilla
    textura=t.crear_texturas("texturas/amarillo_4.jpg", 1, 1);
    //190-210
    cu.crear_cubo(
      200,
      195,
    ...
    //partes altas
    //izquierda
    textura=t.crear_texturas("texturas/amarillo.jpg", 2, 2);
    cu.crear_cubo(
      50,
      290,
      -130,
    ...
    textura=t.crear_texturas("texturas/muro3.jpg", 5, 1);
    cu.crear_cubo(-6, 15, -30, 275, 30, 50, textura, false, 0, 0, 0, 1, 1, 1);
    pivotPoint.add(cubo);

    textura=t.crear_texturas("texturas/muro.jpg", 5, 0.5);
    ...
    textura=t.crear_texturas("texturas/muro.jpg", 4, 0.1);
    ...
    textura=t.crear_texturas("texturas/amarillo_3.jpg", 4, 0.1);
    cu.crear_cubo(
      200,
      150,
      -515,
    ...
    //PUERTAS
    textura=t.crear_texturas("texturas/puerta.png", 1, 0.6);
    textura2 = textura;
    textura=t.crear_texturas("texturas/puerta.png", 1, 1);
    this.puertas(-66, -55, 0, 0, 0, 0, 1.9, 1.55, 1, textura2, textura);

    pivotPoint.add(pivotPuerta);
    //*******puerta izquierda
    pivotPuerta = pivotPuerta2;
    this.puertas(-133, -47, 0, 0, 0, 0, 1.3, 1.4, 1, textura2, textura);

    pivotPoint.add(pivotPuerta);

    //puerta derecha
    pivotPuerta = pivotPuerta3;
    this.puertas(165, -47, 0, 0, 0, 0, 1.3, 1.4, 1, textura2, textura);
    pivotPoint.add(pivotPuerta);
    ...
    //ventana derecha
    //cuadrado
    textura=t.crear_texturas("texturas/ventana.png", 1, 0.5);
    textura2 = textura;
    textura=t.crear_texturas("texturas/ventana.png", 1, 1.05);
    pivotPuerta = ventana1;
    this.puertas(250, 205, 0, 0, 0, 0, 0.7, 0.5, 1, textura2, textura);
    pivotPoint.add(pivotPuerta);
    //ventana izquierd
    pivotPuerta = ventana2;
    this.puertas(-50, 205, 0, 0, 0, 0, 0.7, 0.5, 1, textura2, textura);
    pivotPoint.add(pivotPuerta);
    //VENTANAS CENTRALES
    pivotPuerta = ventana3;
    this.puertas(160, 175, 0, 0, 0, 0, 0.6, 0.4, 1, textura2, textura);
    pivotPoint.add(pivotPuerta);
    pivotPuerta = ventana4;
    this.puertas(60, 175, 0, 0, 0, 0, 0.6, 0.4, 1, textura2, textura);
    pivotPoint.add(pivotPuerta);
    //ventana redonda
    //parte blanca
    textura=t.crear_texturas("texturas/blanco.jpg", 1, 1.05);
    ci.crearCilindro(
      195,
      210,
      -50,
    ...
    this.partealta(350);
    //TRIANGULO
    textura=t.crear_texturas("texturas/amarillo_2.jpg", 1, 1.05);
    this.cargar_triangulo(120, 270, -85, 0, 0, 0, textura, false);
    pivotPoint.add(triangulo);
    //partes de lados figura
    this.cargar_modelo(-60, 0, -85, 0, 0, 0);
    pivotPoint.add(mallaextrusion);

    this.cargar_modelo(-60, 0, -160, 0, 0, 0);
    pivotPoint.add(mallaextrusion);

    this.cargar_modelo(-60, 0, -235, 0, 0, 0);
    pivotPoint.add(mallaextrusion);

    this.cargar_modelo(-60, 0, -305, 0, 0, 0);
    pivotPoint.add(mallaextrusion);

    this.cargar_modelo(-60, 0, -375, 0, 0, 0);
    pivotPoint.add(mallaextrusion);

    //derecha
    this.cargar_modelo(460, 0, -55, 0, Math.PI, 0);
    pivotPoint.add(mallaextrusion);

    this.cargar_modelo(460, 0, -130, 0, Math.PI, 0);
    pivotPoint.add(mallaextrusion);

    this.cargar_modelo(460, 0, -205, 0, Math.PI, 0);
    pivotPoint.add(mallaextrusion);

    this.cargar_modelo(460, 0, -275, 0, Math.PI, 0);
    pivotPoint.add(mallaextrusion);

    this.cargar_modelo(460, 0, -345, 0, Math.PI, 0);
    pivotPoint.add(mallaextrusion);

    //atras izquierda
    this.cargar_modelo(-120, 0, -355, 0, Math.PI / 2, 0);
    pivotPoint.add(mallaextrusion);

    this.cargar_modelo(-190, 0, -355, 0, Math.PI / 2, 0);
    pivotPoint.add(mallaextrusion);

    //atras derecha
    this.cargar_modelo(560, 0, -355, 0, Math.PI / 2, 0);
    pivotPoint.add(mallaextrusion);

    this.cargar_modelo(480, 0, -355, 0, Math.PI / 2, 0);
    pivotPoint.add(mallaextrusion);
  ...
  partealta(posx_a) {
    ...
    textura=t.crear_texturas("texturas/piedra.webp", 0.1, 0.1);
    e.crear_esfera(
      posx_a,
      360,
      -130,
    ...
    //iz mas pequeña
    textura=t.crear_texturas("texturas/blanco.jpg", 1, 1);
    ci.crearCilindro(
      posx_a,
      415,
      -130,
    ...
    pivotPoint.add(sphere);
    //parte negra pequeña
    textura=t.crear_texturas("texturas/negro.jpg", 1, 1);
    pivotPuerta = Puertapeque1;
    this.puertas(10, 395, -62, 0, 0, 0, 0.3, 0.25, 1, textura, textura);
    pivotPoint.add(pivotPuerta);
    pivotPuerta = Puertapeque2;
    this.puertas(310, 395, -62, 0, 0, 0, 0.3, 0.25, 1, textura, textura);
    pivotPoint.add(pivotPuerta);
  }
  ...
  cargar_modelo(pos_x, pos_y, pos_z, rot_x, rot_y, rot_z) {
    ...
    this.scene.add(mallaextrusion);
    return mallaextrusion;
