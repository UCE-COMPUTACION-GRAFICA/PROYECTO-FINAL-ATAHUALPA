...
crearArboles(){
    ...
    this.FiguraArbol(-230,15,100,0,0,0,1.5,1.2,1.5);
    arbl=arbl1;
    this.FiguraArbol(-330,15,160,0,0,0,0.7,1.4,0.8);
    arbl=arbl2;
    this.FiguraArbol(-330,15,160,0,0,0,0.7,1.4,0.8);
...
FiguraArbol(pos_x, pos_y, pos_z, rot_x, rot_y, rot_z,esc_x, esc_y, esc_z){
    ...
    //parte del tronco
    textura=t.crear_texturas("texturas/textura_madera.jpg", 1, 2);
   ...
   ci.darColor=true;
    ...
    //capa de arbol
    textura=t.crear_texturas("texturas/cipresverde.jpg", 3, 3);
